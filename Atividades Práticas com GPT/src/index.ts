class Animal {
    ...
    constructor(
        ...
        nomeParametro?:string,//nome é opcional
    ) 
    {
...
Crie uma classe Cachorro que herda de Animal e sobrescreve o método emitirSom para 
imprimir uma mensagem específica de latido. Adicione um método getRaca na classe 
Cachorro para retornar a raça do cachorro.
*/
/*
...
class Veiculo {
    ...
    constructor(
        tipoParametro:string,
        marcaParametro:string,
        rodasParametro:number,
        motorParametro:boolean,
    ) 
    {
        this.tipo=tipoParametro;
...
class Usuário {
    ...
    idade: number;
    amigos: Usuário[];
    atualizacaoStatus: string[];

    constructor(nomeParametro: string, idadeParametro: number) {
    ...
    adicionarAmigo(amigo: Usuário) {
        this.amigos.push(amigo);
        console.log(`${amigo.nome} foi adicionado como amigo.`);
    }

    postarStatus(status: string) {
...
class Biblioteca {
    ...
    emprestarLivro(titulo: string, nomeMembro: string) {
...
class Galeria {
    ...
    listarObrasPorArtista(nomeArtista: string) {
...
import {Pessoa, Cidade, Critério} from "./model"
...
import ContaBanco from "./modelbanco/ContaBanco";
